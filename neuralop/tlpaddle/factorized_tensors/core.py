...
class FactorizedTensor(paddle.nn.Layer, metaclass=MetaFactorizedTensor):
    ...
    def __init_subclass__(cls, name, **kwargs):
        ...
        if name != "":
            ...
            cls._name = name
        elif cls.__name__ != "TensorizedTensor":
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if cls is FactorizedTensor:
            ...
            try:
                ...
                raise ValueError(
                    f"Got factorization={factorization} but expectedone of {cls._factorizations.keys()}"
                )
    ...
    @classmethod
    def __paddle__function__(cls, func, types, args=(), kwargs=None):
        if kwargs is None:
            kwargs = {}
...
class TensorizedTensor(FactorizedTensor, metaclass=MetaFactorizedTensor, name=""):
    ...
    def from_matrix(
        ...
        **kwargs,
        ...
        Parameters
        ----------
        matrix : paddle.Tensor of order 2
            matrix to decompose
